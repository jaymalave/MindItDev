...
import AdminCreate from "./pages/Account/Admin/Admins/Create";
import AdminMaster from "./pages/Account/Admin/Master/index";
import PrivateRoute from "./components/PrivateRoute/index";
import AdminDoctor from "./pages/Account/Admin/Doctor/index";
import DoctorShow from "./pages/Account/Admin/Doctor/Show";
      ...
      <Router>
        <ScrollToTop>
          <Switch>
            ...
            <PrivateRoute exact path="/admin/doctor" role="manager">
              <AdminDoctor />
            </PrivateRoute>
            <PrivateRoute exact path="/admin/doctor/:id/show" role="manager">
              <DoctorShow />
            </PrivateRoute>
